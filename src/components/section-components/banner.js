			      ...
			      <div className="col-lg-7 order-lg-1 align-self-center">
			        <div className="fadeL banner-inner text-center text-lg-left mt-5 mt-lg-0 p-4 banner-title" >
			          ...
			          <div className='btnContainer'>
						...
						<a className="btn btn-base b-animate-3 mr-sm-3 mr-2" href="https://dot-learning.mpwt.gov.la/course" target='_blank'>{tran('lesson')}</a>
						{/* <Link className="btn btn-border-black b-animate-3" to="/">Read More</Link> */}
						<a className="btn btn-border-black b-animate-3" href="https://dot-learning.mpwt.gov.la/exam" target='_blank'>{tran('test')}</a>
					  </div>
			        </div>
			      </div>
			    </div>
