            ...
            <div className="container">
                <div className="row pd-bottom-70" >
                    ...
                    <div className="col-12 col-md-9 py-2">
                        <h3 className="fw-bold fs-4">A2 - ລົດຈັກສາມລໍ້ສ່ວນຕົວ ລົດສອງລໍ້ ແລະ ສາມລໍ້ໂດຍສານ
                            <br/> Private three-wheels vehicle Passenger vehicle with two-wheels and three-wheels
                        </h3>
                        <br/>
                ...
                <table className='table table-bordered'>
                    ...
                    <tbody>
                    <tr>
                        <td>1. ຄວາມຮູ້ກ່ຽວກັບກົດໝາຍຈະລາຈອນ ກົດໝາຍກ່ຽວກັບສາມລໍ້</td>
                        <td>1</td>
                        <td>-</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>3. ຄວາມຮູ້ກ່ຽວກັບການບຳລຸງຮັກສາລົດສາມລໍ້ເຄື່ອງ ແລະ ອຸປະກອນຄວບຄຸມລົດ</td>
                        <td>1</td>
                        <td>-</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>5. ຄວາມຮູ້ເບື້ອງຕົ້ນກ່ຽວກັບລົດ ແລະ ພື້ນຖານການຂັບຂີ່ລົດສາມລໍ້
                            <ul>
