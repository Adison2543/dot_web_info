...
const Policy = () => {
    return <div>
        <strong>Privacy Policy</strong> <p>
                  ...
                  Department of Transport, Lao PDR at no cost and is intended for use as
                  is.
                </p> <p>
                  ...
                  DoT Smart App unless otherwise defined in this Privacy Policy.
                </p> <p><strong>Information Collection and Use</strong></p> <p>
                  For a better experience, while using our Service, we
                  may require you to provide us with certain personally
                  identifiable information, including but not limited to Name, Phone number, email, ID number. The information that
