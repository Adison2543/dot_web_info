...
const BlogDetails = () => {
	...
	return ( <HelMet>
		...
		<meta name="description" key="description" content={"Description DOT"} />
		<meta name="title" key="title" content={"DOT"} />
		<meta property="og:title" key="og:title" content={"DOT"} />
		...
		<meta
		  ...
		  key="og:description"
		  content={"Description DOT"}
		/>
		<meta
		  property="og:image"
		  key="og:image"
		  content={`https://th.bing.com/th/id/R.7fa5e17cefa179b2e6992ec6a1fd3c2d?rik=hlz9QVxuonnbmA&pid=ImgRaw&r=0`}
		/>  
	  </HelMet>)
