						...
						<div className="col-lg-8">
							<div className="row justify-content-center">
								...
								<div className="col-md-6">
									...
									<div className="thumb">
										<img src={"https://dot-api.mpwt.gov.la/media_file/file/?f=" + news[0]?.news_cover} style={{objectFit: 'cover'}} width={370} height={250}  alt="img" />
								...
								<div className="col-md-6">
									<div className="single-blog-inner type-1">
									<div className="thumb">
										<img src={"https://dot-api.mpwt.gov.la/media_file/file/?f=" + news[1]?.news_cover} style={{objectFit: 'cover'}} width={370} height={250} alt="img" />
